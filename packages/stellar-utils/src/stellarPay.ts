...
/**
 * Builds, signs, and submits a USDC payment on Stellar Testnet.
...
/**
 * Verifies that a Stellar transaction hash represents a valid USDC payment
 * of at least `requiredAmount` to `recipientAddress`.
 */
